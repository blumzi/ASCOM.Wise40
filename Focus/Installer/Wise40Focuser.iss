...
AppName=ASCOM Wise40.Focuser Focuser Driver
AppVerName="ASCOM {param:ProjectName} Focuser Driver 6.2.0.0"
AppVersion=6.2.0.0
...
OutputDir="."
OutputBaseFilename="Focuser Setup"
Compression=lzma
...
UninstallFilesDir="{cf}\ASCOM\Uninstall\Focuser\ComputerControl"
...
[Files]
Source: "{#SolutionDir}\Focus\bin\Debug\ASCOM.Wise40.Focuser.dll"; DestDir: "{app}"
Source: "{#SolutionDir}\Focus\Installer\ReadMe.html"; DestDir: "{app}"; Flags: isreadme
