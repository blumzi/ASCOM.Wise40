...
[Files]
Source: "{#SolutionDir}\SafeToOpen\bin\Debug\ASCOM.Wise40.SafeToOpen.SafetyMonitor.dll"; DestDir: "{app}"
Source: "{#SolutionDir}\SafeToOpen\Installer\ReadMe.html"; DestDir: "{app}"; Flags: isreadme
