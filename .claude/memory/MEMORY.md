...
- [Slew time: where it goes](slew-time-where-it-goes.md) — where slew time actually goes on both axes, verified on sky. **HA coast is direction dependent** (east 2.00°, west 2.81°); RA coast figures before 2026-09-18 are wrong because the stop detector was; **it is still blind at guide rate, so every `rateGuide` coast of 0.0″ in the logs is an artifact**
