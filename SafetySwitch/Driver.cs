...
//
// ASCOM SafetyMonitor driver for Wise40
//
...
{
    //
    // Your driver's DeviceID is ASCOM.Wise40.SafetyMonitor
    //
    // The Guid attribute sets the CLSID for ASCOM.Wise40.SafetyMonitor
    ...
    /// ASCOM SafetyMonitor Driver for Wise40.
    /// </summary>
    [Guid("69cf795a-03ab-44c6-9ee0-7e7c4f9881d2")]
    ...
    public class SafetyMonitor : ISafetyMonitor
    {
        ...
        private WiseSafetySwitch wisesafety = WiseSafetySwitch.Instance;
        ...
        public string DriverInfo
        {
            get
            {
                ...
                string driverInfo = "Wise40 SafetySwitch driver. Version: " + String.Format(CultureInfo.InvariantCulture, "{0}.{1}", version.Major, version.Minor);
        ...
        public string Name
        {
            get
            {
                string name = "Wise40 SafetySwitch";
