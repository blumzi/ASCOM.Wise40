...
namespace Dash
{
    public partial class FilterWheelForm : Form
    {
        ...
        {
            labelCurrentWheelValue.Text = string.IsNullOrEmpty(wisefilterwheel.wheel.name) ? "Unknown" : wisefilterwheel.wheel.name;
            ...
            {
                Label label = (Label)table.Controls.Find(string.Format("label{0}Filter{1}", wisefilterwheel.wheel.name, i), true)[0];
